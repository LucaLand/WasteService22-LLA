...
class TestWasteServiceApplicationQakSprint2 {
    ...
    fun transportTrolleyStop() {
        ...
        println("$testName	|	testaccept on message: $depositRequest")
        try {
        ...
        val sonarDataAppl1 = "msg(sonardataAppl, event, testunit, none, distance(50), 12)"
        val sonarDataApplStop = "msg(sonardataAppl, event, testunit, none, distance(5), 18)"
        val sonarDataAppl3 = "msg(sonardataAppl, event, testunit, none, distance(15), 24)"



        try {
            println("$testName	|   Message: $sonarDataAppl1")
            conn.forward(sonarDataAppl1)
            CommUtils.delay(3000)

            println("$testName	|	Message: $sonarDataApplStop")
            conn.forward(sonarDataApplStop)
            ...
            println("$testName	|	Message: $sonarDataAppl3")
            conn.forward(sonarDataAppl3)
