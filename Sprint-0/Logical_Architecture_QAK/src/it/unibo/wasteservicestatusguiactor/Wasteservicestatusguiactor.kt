...
package it.unibo.wasteservicestatusguiactor
...
class Wasteservicestatusguiactor ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
				...
				state("handleChanges") { //this:State
					...
					sysaction { //it:State
				 	 		stateTimer = TimerActor("timer_handleChanges", 
				 	 					  scope, context!!, "local_tout_wasteservicestatusguiactor_handleChanges", 20000.toLong() )
					}	 	 
					 transition(edgeName="t09",targetState="handleChanges",cond=whenTimeout("local_tout_wasteservicestatusguiactor_handleChanges"))   
				}	 
